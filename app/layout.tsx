  ...
  return (
    <html lang="en" className={`${inter.variable} ${mono.variable}`}>
      <body className={inter.className}>
        ...
        */}
        <header className="fixed top-0 left-0 w-full px-6 md:px-12 py-4 flex justify-between items-center bg-white/80 backdrop-blur-md z-50 border-b border-gray-200/50">
          <Link href="/" className="font-mono font-bold text-xl text-gray-900 tracking-tighter hover:text-blue-700 transition-colors">
